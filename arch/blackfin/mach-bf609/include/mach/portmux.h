...
#define P_LP0_CLK	(P_DEFINED | P_IDENT(GPIO_PE9) | P_FUNCT(2))
#define P_LP0_ACK       (P_DEFINED | P_IDENT(GPIO_PE8) | P_FUNCT(2))
#define P_LP0_D0        (P_DEFINED | P_IDENT(GPIO_PF8) | P_FUNCT(2))
#define P_LP0_D1        (P_DEFINED | P_IDENT(GPIO_PF9) | P_FUNCT(2))
#define P_LP0_D2        (P_DEFINED | P_IDENT(GPIO_PF10) | P_FUNCT(2))
#define P_LP0_D3        (P_DEFINED | P_IDENT(GPIO_PF11) | P_FUNCT(2))
#define P_LP0_D4        (P_DEFINED | P_IDENT(GPIO_PF12) | P_FUNCT(2))
#define P_LP0_D5        (P_DEFINED | P_IDENT(GPIO_PF13) | P_FUNCT(2))
#define P_LP0_D6        (P_DEFINED | P_IDENT(GPIO_PF14) | P_FUNCT(2))
#define P_LP0_D7        (P_DEFINED | P_IDENT(GPIO_PF15) | P_FUNCT(2))
