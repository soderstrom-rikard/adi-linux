...
enum {
	...
	AWA_toggle = SYSCR,
	AWA_maska = UART0_SCR,
	AWA_maska_clear = UART0_SCR,
	AWA_maska_set = UART0_SCR,
	AWA_maska_toggle = UART0_SCR,
	AWA_maskb = UART0_GCTL,
	AWA_maskb_clear = UART0_GCTL,
	AWA_maskb_set = UART0_GCTL,
	AWA_maskb_toggle = UART0_GCTL,
	AWA_dir = SPORT1_STAT,
