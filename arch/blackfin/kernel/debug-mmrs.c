...
# define USE_BF512 0
	...
	if (USE_BF512) {
		...
		d("PWM_CHA", 16, 0xFFC03714);
		d("PWM_CHAL", 16, 0xFFC03728);
		d("PWM_CHB", 16, 0xFFC03718);
		d("PWM_CHBL", 16, 0xFFC0372C);
		d("PWM_CHC", 16, 0xFFC0371C);
		d("PWM_CHCL", 16, 0xFFC03730);
		d("PWM_CTRL", 16, 0xFFC03700);
		d("PWM_DT", 16, 0xFFC0370C);
		d("PWM_GATE", 16, 0xFFC03710);
		d("PWM_LSI", 16, 0xFFC03734);
		d("PWM_SEG", 16, 0xFFC03720);
		d("PWM_STAT2", 16, 0xFFC03738);
		d("PWM_STAT", 16, 0xFFC03704);
		d("PWM_SYNCWT", 16, 0xFFC03724);
		d("PWM_TM", 16, 0xFFC03708);
		...
		d("SECURE_STATUS", 16, 0xFFC03628);
		d("SECURE_SYSSWT", 32, 0xFFC03620);

		parent = debugfs_create_dir("System Interrupt Controller Register File", top);
		d("SIC_IAR0", 32, 0xFFC00110);
		d("SIC_IAR1", 32, 0xFFC00114);
		d("SIC_IAR2", 32, 0xFFC00118);
		d("SIC_IAR3", 32, 0xFFC0011C);
		d("SIC_IAR4", 32, 0xFFC00150);
		d("SIC_IAR5", 32, 0xFFC00154);
		d("SIC_IAR6", 32, 0xFFC00158);
		d("SIC_IAR7", 32, 0xFFC0015C);
		d("SIC_IMASK0", 32, 0xFFC0010C);
		d("SIC_IMASK1", 32, 0xFFC0014C);
		d("SIC_ISR0", 32, 0xFFC00120);
		d("SIC_ISR1", 32, 0xFFC00160);
		d("SIC_IWR0", 32, 0xFFC00124);
		d("SIC_IWR1", 32, 0xFFC00164);
...
# define USE_BF514 0
	...
	if (USE_BF514) {
		...
		d("RSI_ARGUMENT", 32, 0xFFC03808);
		d("RSI_CEATA_CONTROL", 16, 0xFFC0384C);
		d("RSI_CLK_CONTROL", 16, 0xFFC03804);
		d("RSI_COMMAND", 16, 0xFFC0380C);
		d("RSI_CONFIG", 16, 0xFFC038C8);
		d("RSI_DATA_CNT", 16, 0xFFC03830);
		d("RSI_DATA_CONTROL", 16, 0xFFC0382C);
		d("RSI_DATA_LGTH", 16, 0xFFC03828);
		d("RSI_DATA_TIMER", 32, 0xFFC03824);
		d("RSI_EMASK", 16, 0xFFC038C4);
		d("RSI_ESTAT", 16, 0xFFC038C0);
		d("RSI_FIFO", 32, 0xFFC03880);
		d("RSI_FIFO_CNT", 16, 0xFFC03848);
		d("RSI_MASK0", 32, 0xFFC0383C);
		d("RSI_MASK1", 32, 0xFFC03840);
		d("RSI_PID0", 16, 0xFFC038D0);
		d("RSI_PID1", 16, 0xFFC038D4);
		d("RSI_PID2", 16, 0xFFC038D8);
		d("RSI_PID3", 16, 0xFFC038DC);
		d("RSI_PWR_CONTROL", 16, 0xFFC03800);
		d("RSI_RD_WAIT_EN", 16, 0xFFC038CC);
		d("RSI_RESPONSE0", 32, 0xFFC03814);
		d("RSI_RESPONSE1", 32, 0xFFC03818);
		d("RSI_RESPONSE2", 32, 0xFFC0381C);
...
# define USE_BF531 0
	...
	if (USE_BF531) {
		...
		d("SIC_IAR2", 32, 0xFFC00118);
		d("SIC_IAR3", 32, 0xFFC0011C);
		d("SIC_IMASK", 32, 0xFFC0010C);
		d("SIC_ISR", 32, 0xFFC00120);
		d("SIC_IWR", 32, 0xFFC00124);
		d("SIC_RVECT", 16, 0xFFC00108);
...
# define USE_BF538 0
	...
	if (USE_BF538) {
		...
		d("SIC_IAR2", 32, 0xFFC00118);
		d("SIC_IAR3", 32, 0xFFC0011C);
		d("SIC_IAR4", 32, 0xFFC00134);
		d("SIC_IAR5", 32, 0xFFC00138);
		d("SIC_IAR6", 32, 0xFFC0013C);
		d("SIC_IMASK0", 32, 0xFFC0010C);
		d("SIC_IMASK1", 32, 0xFFC00128);
		d("SIC_ISR0", 32, 0xFFC00120);
		d("SIC_ISR1", 32, 0xFFC0012C);
		d("SIC_IWR0", 32, 0xFFC00124);
		d("SIC_IWR1", 32, 0xFFC00130);
		d("SIC_RVECT", 16, 0xFFC00108);
		d("SWRST", 16, 0xFFC00100);
		d("SYSCR", 16, 0xFFC00104);
...
# define USE_BF542 0
	...
	if (USE_BF542) {
		...
		d("SDH_CFG", 16, 0xFFC039C8);
		d("SDH_CLK_CTL", 16, 0xFFC03904);
		d("SDH_COMMAND", 16, 0xFFC0390C);
		d_RO("SDH_DATA_CNT", 16, 0xFFC03930);
		d("SDH_DATA_CTL", 16, 0xFFC0392C);
		d("SDH_DATA_LGTH", 16, 0xFFC03928);
		d("SDH_DATA_TIMER", 32, 0xFFC03924);
		d("SDH_E_MASK", 16, 0xFFC039C4);
		d("SDH_E_STATUS", 16, 0xFFC039C0);
		d("SDH_FIFO", 32, 0xFFC03980);
		d_RO("SDH_FIFO_CNT", 16, 0xFFC03948);
		d("SDH_MASK0", 32, 0xFFC0393C);
		d("SDH_MASK1", 32, 0xFFC03940);
		d_RO("SDH_PID0", 16, 0xFFC039D0);
		d_RO("SDH_PID1", 16, 0xFFC039D4);
		d_RO("SDH_PID2", 16, 0xFFC039D8);
		d_RO("SDH_PID3", 16, 0xFFC039DC);
		d_RO("SDH_PID4", 16, 0xFFC039E0);
		d_RO("SDH_PID5", 16, 0xFFC039E4);
		d_RO("SDH_PID6", 16, 0xFFC039E8);
		d_RO("SDH_PID7", 16, 0xFFC039EC);
		d("SDH_PWR_CTL", 16, 0xFFC03900);
		d("SDH_RD_WAIT_EN", 16, 0xFFC039CC);
		d_RO("SDH_RESPONSE0", 32, 0xFFC03914);
		d_RO("SDH_RESPONSE1", 32, 0xFFC03918);
		d_RO("SDH_RESPONSE2", 32, 0xFFC0391C);
		d_RO("SDH_RESPONSE3", 32, 0xFFC03920);
		d_RO("SDH_RESP_CMD", 16, 0xFFC03910);
		d_RO("SDH_STATUS", 32, 0xFFC03934);
		d_WO("SDH_STATUS_CLR", 16, 0xFFC03938);

		parent = debugfs_create_dir("SIC", top);
		d("SIC_IAR0", 32, 0xFFC00130);
		d("SIC_IAR10", 32, 0xFFC00158);
		d("SIC_IAR11", 32, 0xFFC0015C);
		d("SIC_IAR1", 32, 0xFFC00134);
		d("SIC_IAR2", 32, 0xFFC00138);
		d("SIC_IAR3", 32, 0xFFC0013C);
		d("SIC_IAR4", 32, 0xFFC00140);
		d("SIC_IAR5", 32, 0xFFC00144);
		d("SIC_IAR6", 32, 0xFFC00148);
		d("SIC_IAR7", 32, 0xFFC0014C);
		d("SIC_IAR8", 32, 0xFFC00150);
		d("SIC_IAR9", 32, 0xFFC00154);
		d("SIC_IMASK0", 32, 0xFFC0010C);
		d("SIC_IMASK1", 32, 0xFFC00110);
		d("SIC_IMASK2", 32, 0xFFC00114);
		d("SIC_ISR0", 32, 0xFFC00118);
		d("SIC_ISR1", 32, 0xFFC0011C);
		d("SIC_ISR2", 32, 0xFFC00120);
		d("SIC_IWR0", 32, 0xFFC00124);
		d("SIC_IWR1", 32, 0xFFC00128);
		d("SIC_IWR2", 32, 0xFFC0012C);
		...
		d("SECURE_STATUS", 16, 0xFFC04328);
		d("SECURE_SYSSWT", 32, 0xFFC04320);
