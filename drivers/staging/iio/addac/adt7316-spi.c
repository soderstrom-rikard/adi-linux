/*
 * API bus driver for ADT7316/7/8 digital temperature sensor, ADC and DAC
 *
...
MODULE_DESCRIPTION("SPI bus driver for Analog Devices ADT7316/7/8 digital"
			" temperature sensor, ADC and DAC");
