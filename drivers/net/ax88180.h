/* ax88180.h: ASIX AX88180 Non-PCI Gigabit Ethernet Linux driver */
...
#define PLATFORM_MEMBASE		0x20200000
#define PLATFORM_IRQ			IRQ_PF4	
...
#define	IMR		0x1F04
  ...
  #define	DEFAULT_IMR		(IMR_PHY | IMR_RX | IMR_TX | IMR_RXBUFFOVR | IMR_WATCHDOG)
#define	ISR		0x1F08
...
#define	TXPAUT		0x1F54
  #define	DEFAULT_TXPAUT		0x001FE000
  #define	DEFAULT_TXPAUT_PSW	0x0000FFFF
#define	RXBTHD0		0x1F58
  #define	DEFAULT_RXBTHD0		0x00000300
#define	RXBTHD1		0x1F5C
  #define	DEFAULT_RXBTHD1		0x00000600
#define	RXFULTHD	0x1F60
...
#define	MACID0		0x1F70
#define	MACID1		0x1F74
#define	MACID2		0x1F78
#define	TXLEN		0x1F7C
  #define	DEFAULT_TXLEN		0x000005FC
#define	RXFILTER	0x1F80
...
#define	MDIOCTRL	0x1F84
  #define	PHY_ADDR_MASK		0x0000001F
  #define	REG_ADDR_MASK		0x00001F00
  #define	READ_PHY		0x00004000
  #define 	WRITE_PHY		0x00008000
#define	MDIODP		0x1F88
#define	GPIOCTRL	0x1F8C
#define	RXINDICATOR	0x1F90
  #define	RX_START_READ		0x00000001
  #define	RX_STOP_READ		0x00000000
  #define	DEFAULT_RXINDICATOR	RX_STOP_READ
#define	TXST		0x1F94
#define	MDCCLKPAT	0x1FA0
#define	RXIPCRCCNT	0x1FA4
#define	RXCRCCNT	0x1FA8
#define	TXFAILCNT	0x1FAC
#define	PROMDP		0x1FB0
#define	PROMCTRL	0x1FB4
  #define	RELOAD_EEPROM		0x00000200
#define	MAXRXLEN	0x1FB8
#define	HASHTAB0	0x1FC0
#define	HASHTAB1	0x1FC4
#define	HASHTAB2	0x1FC8
#define	HASHTAB3	0x1FCC
#define	DOGTHD0		0x1FE0
  #define	DEFAULT_DOGTHD0		0x0000FFFF
#define	DOGTHD1		0x1FE4
  #define	START_WATCHDOG_TIMER	0x00008000
  #define	DEFAULT_DOGTHD1		0x00000FFF
#define	SOFTRST		0x1FEC
...
#define	DEFAULT_MSG  (DRIVER_MSG|ERROR_MSG|WARNING_MSG) 
// #define	DEFAULT_MSG  (INIT_MSG|TX_MSG|RX_MSG|DRIVER_MSG|ERROR_MSG|WARNING_MSG) 
#define	DEBUG_FLAGS			DEFAULT_MSG


/* The constant defined in the linux/ethtool.h file */
