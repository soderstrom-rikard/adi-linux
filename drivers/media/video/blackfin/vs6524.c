...
static ssize_t sysfs_sysfs_show_val(struct device *cd, struct device_attribute *attr, char *buf, int cmd)
{
...
static ssize_t
sysfs_sysfs_store_val(struct device *cd, struct device_attribute *attr, const char *buf, size_t len,
		      int cmd)
{
	struct bcap_device_t *cam;
	u8 value;
...
static ssize_t sysfs_fps_show(struct device *cd, struct device_attribute *attr, char *buf)
{
	...
	return sysfs_sysfs_show_val(cd, attr, buf, CAM_CMD_GET_FRAMERATE);
}

static ssize_t
sysfs_fps_store(struct device *cd, struct device_attribute *attr, const char *buf, size_t len)
{
	return sysfs_sysfs_store_val(cd, attr, buf, len, CAM_CMD_SET_FRAMERATE);
}
...
{
	return sysfs_sysfs_show_val(cd, attr, buf, CAM_CMD_GET_FLICKER_FREQ);
}

static ssize_t
sysfs_flicker_store(struct device *cd, struct device_attribute *attr, const char *buf, size_t len)
{
	return sysfs_sysfs_store_val(cd, attr, buf, len, CAM_CMD_SET_FLICKER_FREQ);
}
...
{
	return sysfs_sysfs_show_val(cd, attr, buf, CAM_CMD_GET_HOR_MIRROR);
}

static ssize_t
sysfs_h_mirror_store(struct device *cd, struct device_attribute *attr, const char *buf, size_t len)
{
	return sysfs_sysfs_store_val(cd, attr, buf, len, CAM_CMD_SET_HOR_MIRROR);
}
...
{
	return sysfs_sysfs_show_val(cd, attr, buf, CAM_CMD_GET_VERT_MIRROR);
}

static ssize_t
sysfs_v_mirror_store(struct device *cd, struct device_attribute *attr, const char *buf, size_t len)
{
	return sysfs_sysfs_store_val(cd, attr, buf, len, CAM_CMD_SET_VERT_MIRROR);
}
