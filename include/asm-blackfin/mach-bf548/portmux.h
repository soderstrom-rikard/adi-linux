...
#define P_SPI0_SEL1	(P_DEFINED | P_IDENT(GPIO_PE4) | P_FUNCT(0))
#define P_SPI0_SEL2	(P_DEFINED | P_IDENT(GPIO_PE5) | P_FUNCT(0))
#define P_SPI0_SEL3	(P_DEFINED | P_IDENT(GPIO_PE6) | P_FUNCT(0))
...
#define P_SPI1_SEL1	(P_DEFINED | P_IDENT(GPIO_PG5) | P_FUNCT(0))
#define P_SPI1_SEL2	(P_DEFINED | P_IDENT(GPIO_PG6) | P_FUNCT(0))
#define P_SPI1_SEL3	(P_DEFINED | P_IDENT(GPIO_PG7) | P_FUNCT(0))
