...
#define P_SPISEL7	(P_DEFINED | P_IDENT(GPIO_PF7))
#define P_SPISEL6	(P_DEFINED | P_IDENT(GPIO_PF6))
#define P_SPISEL5	(P_DEFINED | P_IDENT(GPIO_PF5))
#define P_SPISEL4	(P_DEFINED | P_IDENT(GPIO_PF4))
#define P_SPISEL3	(P_DEFINED | P_IDENT(GPIO_PF3))
#define P_SPISEL2	(P_DEFINED | P_IDENT(GPIO_PF2))
#define P_SPISEL1	(P_DEFINED | P_IDENT(GPIO_PF1))
#define P_SPISS		(P_DEFINED | P_IDENT(GPIO_PF0))
