...
static const u16 ad1980_reg[] = {
	0x0090, 0x8000, 0x8000, 0x8000, /* 6  */
	0x0000, 0x0000, 0x8008, 0x8008, /* e  */
	0x8808, 0x8808, 0x0000, 0x8808, /* 16 */
	0x8808, 0x0000, 0x8000, 0x0000, /* 1e */
	0x0000, 0x0000, 0x0000, 0x0000, /* 26 */
	0x03c7, 0x0000, 0xbb80, 0xbb80, /* 2e */
	0xbb80, 0xbb80, 0x0000, 0x8080, /* 36 */
	0x8080, 0x2000, 0x0000, 0x0000, /* 3e */
	0x0000, 0x0000, 0x0000, 0x0000, /* 46 */
	0x0000, 0x0000, 0x0000, 0x0000, /* 4e */
	0x0000, 0x0000, 0x0000, 0x0000, /* 56 */
	0x0000, 0x0000, 0x0000, 0x0000, /* 5e */
	0x8080, 0x0000, 0x0000, 0x0000, /* 66 */
	0x0000, 0x0000, 0x0000, 0x0000, /* 6e */
	0x0000, 0x0000, 0x1001, 0x0000, /* 76 */
	0x0001, 0x0000, 0x4144, 0x5370  /* 7e */
};
...
static const char *ad1980_alc_select[] = {"None", "Left", "Right", "Stereo"};
static const char *ad1980_alc_mux[] = {"Stereo", "Left", "Right", "None"};
static const char *ad1980_out3_src[] = {"Left", "VREF", "Left + Right",
	"Mono"};
static const char *ad1980_spk_src[] = {"Speaker Mix", "Headphone Mix"};
static const char *ad1980_rec_adc[] = {"Stereo", "Left", "Right", "Mute"};
static const char *ad1980_base[] = {"Linear Control", "Adaptive Boost"};
static const char *ad1980_rec_gain[] = {"+1.5dB Steps", "+0.75dB Steps"};
static const char *ad1980_mic[] = {"Mic 1", "Differential", "Mic 2",
	"Stereo"};
static const char *ad1980_rec_sel[] = {"Mic", "NC", "NC", "Speaker Mixer",
	"Line", "Headphone Mixer", "Phone Mixer", "Phone"};
static const char *ad1980_ng_type[] = {"Constant Gain", "Mute"};
static const char *ad1980_diff_sel[] = {"Mic", "Line"};

static const struct soc_enum ad1980_enum[] = {
SOC_ENUM_SINGLE(AC97_PCI_SVID, 14, 4, ad1980_alc_select),
SOC_ENUM_SINGLE(AC97_VIDEO, 12, 4, ad1980_alc_mux),
SOC_ENUM_SINGLE(AC97_AUX, 9, 4, ad1980_out3_src),
SOC_ENUM_SINGLE(AC97_AUX, 8, 2, ad1980_spk_src),
SOC_ENUM_SINGLE(AC97_REC_SEL, 12, 4, ad1980_rec_adc),
SOC_ENUM_SINGLE(AC97_MASTER_TONE, 15, 2, ad1980_base),
SOC_ENUM_DOUBLE(AC97_REC_GAIN, 14, 6, 2, ad1980_rec_gain),
SOC_ENUM_SINGLE(AC97_MIC, 5, 4, ad1980_mic),
SOC_ENUM_SINGLE(AC97_REC_SEL, 8, 8, ad1980_rec_sel),
SOC_ENUM_SINGLE(AC97_REC_SEL, 0, 8, ad1980_rec_sel),
SOC_ENUM_SINGLE(AC97_PCI_SVID, 5, 2, ad1980_ng_type),
SOC_ENUM_SINGLE(0x5c, 8, 2, ad1980_diff_sel),
};
...
SOC_ENUM("ALC Function", ad1980_enum[0]),
SOC_SINGLE("ALC Max Volume", AC97_PCI_SVID, 11, 7, 0),
SOC_SINGLE("ALC ZC Timeout", AC97_PCI_SVID, 9, 3, 1),
SOC_SINGLE("ALC ZC Switch", AC97_PCI_SVID, 8, 1, 0),
SOC_SINGLE("ALC NG Switch", AC97_PCI_SVID, 7, 1, 0),
SOC_ENUM("ALC NG Type", ad1980_enum[10]),
...
SOC_ENUM("Bass Control", ad1980_enum[5]),
...
SOC_ENUM("Capture Volume Steps", ad1980_enum[6]),
...
static const struct snd_kcontrol_new ad1980_hpl_mixer_controls[] = {
...
static const struct snd_kcontrol_new ad1980_hpr_mixer_controls[] = {
...
/* Speaker Mixer */
static const struct snd_kcontrol_new ad1980_speaker_mixer_controls[] = {
...
/* Phone Mixer */
static const struct snd_kcontrol_new ad1980_phone_mixer_controls[] = {
...
/* ALC headphone mux */
static const struct snd_kcontrol_new ad1980_alc_mux_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[1]);

/* out 3 mux */
static const struct snd_kcontrol_new ad1980_out3_mux_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[2]);

/* spk mux */
static const struct snd_kcontrol_new ad1980_spk_mux_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[3]);

/* Capture to Phone mux */
static const struct snd_kcontrol_new ad1980_capture_phone_mux_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[4]);

/* Capture left select */
static const struct snd_kcontrol_new ad1980_capture_selectl_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[8]);

/* Capture right select */
static const struct snd_kcontrol_new ad1980_capture_selectr_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[9]);

/* Mic select */
static const struct snd_kcontrol_new ad1980_mic_src_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[7]);

/* diff select */
static const struct snd_kcontrol_new ad1980_diff_sel_controls =
SOC_DAPM_ENUM("Route", ad1980_enum[11]);

static const struct snd_soc_dapm_widget ad1980_dapm_widgets[] = {
SND_SOC_DAPM_MUX("ALC Sidetone Mux", SND_SOC_NOPM, 0, 0,
	&ad1980_alc_mux_controls),
SND_SOC_DAPM_MUX("Out3 Mux", SND_SOC_NOPM, 0, 0,
	&ad1980_out3_mux_controls),
SND_SOC_DAPM_MUX("Speaker Mux", SND_SOC_NOPM, 0, 0,
	&ad1980_spk_mux_controls),
SND_SOC_DAPM_MUX("Capture Phone Mux", SND_SOC_NOPM, 0, 0,
	&ad1980_capture_phone_mux_controls),
SND_SOC_DAPM_MUX("Left Capture Select", SND_SOC_NOPM, 0, 0,
	&ad1980_capture_selectl_controls),
SND_SOC_DAPM_MUX("Right Capture Select", SND_SOC_NOPM, 0, 0,
	&ad1980_capture_selectr_controls),
SND_SOC_DAPM_MUX("Mic Select Source", SND_SOC_NOPM, 0, 0,
	&ad1980_mic_src_controls),
SND_SOC_DAPM_MUX("Differential Source", SND_SOC_NOPM, 0, 0,
	&ad1980_diff_sel_controls),
SND_SOC_DAPM_MIXER("AC97 Mixer", SND_SOC_NOPM, 0, 0, NULL, 0),
SND_SOC_DAPM_MIXER_E("Left HP Mixer", AC97_INT_PAGING, 9, 1,
	&ad1980_hpl_mixer_controls[0], ARRAY_SIZE(ad1980_hpl_mixer_controls),
	mixer_event, SND_SOC_DAPM_POST_REG),
SND_SOC_DAPM_MIXER_E("Right HP Mixer", AC97_INT_PAGING, 8, 1,
	&ad1980_hpr_mixer_controls[0], ARRAY_SIZE(ad1980_hpr_mixer_controls),
	 mixer_event, SND_SOC_DAPM_POST_REG),
SND_SOC_DAPM_MIXER("Phone Mixer", AC97_INT_PAGING, 6, 1,
	&ad1980_phone_mixer_controls[0], \
	ARRAY_SIZE(ad1980_phone_mixer_controls)),
SND_SOC_DAPM_MIXER("Speaker Mixer", AC97_INT_PAGING, 7, 1,
	&ad1980_speaker_mixer_controls[0],
	ARRAY_SIZE(ad1980_speaker_mixer_controls)),
...
static int ad1980_add_widgets(struct snd_soc_codec *codec)
{
	int i;

	for (i = 0; i < ARRAY_SIZE(ad1980_dapm_widgets); i++) {
		snd_soc_dapm_new_control(codec, &ad1980_dapm_widgets[i]);
	}
...
static int ad1980_dapm_event(struct snd_soc_codec *codec, int event)
{
	switch (event) {
	case SNDRV_CTL_POWER_D0: /* full On */
		ac97_write(codec, AC97_POWERDOWN, 0x0);
		break;
	case SNDRV_CTL_POWER_D1: /* partial On */
		ac97_write(codec, AC97_POWERDOWN, PR0);
		break;
	case SNDRV_CTL_POWER_D2: /* partial On */
		ac97_write(codec, AC97_POWERDOWN, PR1);
		break;
	case SNDRV_CTL_POWER_D3hot: /* Off, with power */
		ac97_write(codec, AC97_POWERDOWN, PR2);
		break;
	case SNDRV_CTL_POWER_D3cold: /* Off, without power */
		/* disable everything including AC link */
		ac97_write(codec, AC97_POWERDOWN, PR4);
		break;
	}
	...
	pm_message_t state)
{
	...
	ad1980_dapm_event(codec, SNDRV_CTL_POWER_D3cold);
	return 0;
}
...
static int ad1980_soc_resume(struct platform_device *pdev)
{
	...
	ret = ad1980_reset(codec, 1);
	if (ret < 0) {
		printk(KERN_ERR "could not reset AC97 codec\n");
		return ret;
	}

	ad1980_dapm_event(codec, SNDRV_CTL_POWER_D3hot);
	...
	if (codec->suspend_dapm_state == SNDRV_CTL_POWER_D0)
		ad1980_dapm_event(codec, SNDRV_CTL_POWER_D0);
...
static int ad1980_soc_probe(struct platform_device *pdev)
{
	...
	codec->dapm_event = ad1980_dapm_event;
