...
static struct snd_soc_device bf5xx_ad183x_snd_devdata = {
	.card = &bf5xx_ad183x,
	.codec_dev = &soc_codec_dev_ad183x,
};
...
static int __init bf5xx_ad183x_init(void)
{
	...
	platform_set_drvdata(bfxx_ad183x_snd_device, &bf5xx_ad183x_snd_devdata);
	bf5xx_ad183x_snd_devdata.dev = &bfxx_ad183x_snd_device->dev;
