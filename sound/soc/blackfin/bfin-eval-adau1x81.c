...
static const struct snd_soc_card bfin_eval_adau1x81 = {
...
static int bfin_eval_adau1x81_probe(struct platform_device *pdev)
{
	...
	card = kmemdup(&bfin_eval_adau1x81, sizeof(bfin_eval_adau1x81),
			GFP_KERNEL);

	return snd_soc_register_card(card);
}

static int __devexit bfin_eval_adau1x81_remove(struct platform_device *pdev)
{
...
static struct platform_driver bfin_eval_adau1x81_driver = {
	...
	.remove = __devexit_p(bfin_eval_adau1x81_remove),
};
